...
public class MensajeService {
	...
	/**
	 * Registra un nuevo mensaje en la base de datos vinculado a un Tema y un
	 * Usuario.
	 */
	public Mensaje crearMensaje(Mensaje mensaje) {
		...
		// a partir de los IDs que nos llegan del frontend. Esto previene errores de
		// "entidad desconectada".
	...
	public void eliminarMensaje(Integer id) {
		...
		// Si el tema existe, restamos 1 al contador para mantener las estadísticas
		// cuadras
		...
		// Esto es necesario para no violar la restricción de clave foránea
		// (FK_LIKES_MENSAJE)
